...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   POST: () => (/* binding */ POST)\n/* harmony export */ });\n/* harmony import */ var next_server__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! next/server */ \"(rsc)/./node_modules/next/dist/api/server.js\");\n/* harmony import */ var _database_prisma__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @/database/prisma */ \"(rsc)/./src/database/prisma.ts\");\n/* harmony import */ var _helpers_getDataFromToken__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @/helpers/getDataFromToken */ \"(rsc)/./src/helpers/getDataFromToken.ts\");\n\n\n\nasync function POST(req) {\n    try {\n        const body = await req.json();\n        const { workout, createdAt, completed, workoutDay } = body;\n        // Validate request body\n        if (!workout || !createdAt || !completed || !workoutDay) {\n            return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n                error: \"Missing required fields: workout, createdAt, completed, workoutDay\"\n            }, {\n                status: 400\n            });\n        }\n        // Validate completed is a boolean\n        if (typeof completed !== \"boolean\") {\n            return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n                error: \"The 'completed' field must be a boolean\"\n            }, {\n                status: 400\n            });\n        }\n        // Extract user ID from the token\n        const userId = (0,_helpers_getDataFromToken__WEBPACK_IMPORTED_MODULE_2__.getDataFromToken)(req);\n        if (!userId) {\n            return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n                error: \"Invalid token or no user associated with this request\"\n            }, {\n                status: 401\n            });\n        }\n        console.log(userId);\n        // Create a new user workout\n        const userWorkout = await _database_prisma__WEBPACK_IMPORTED_MODULE_1__[\"default\"].userWorkout.create({\n            data: {\n                workout,\n                workoutDay,\n                createdAt,\n                completed,\n                userId\n            }\n        });\n        // Send success response\n        return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n            message: `userWorkout successfully added for User ID: ${userId}`,\n            userWorkout: {\n                id: userWorkout.id,\n                workout: userWorkout.workout,\n                createdAt: userWorkout.createdAt,\n                completed: userWorkout.completed\n            }\n        }, {\n            status: 201\n        });\n    } catch (error) {\n        console.error(\"Error processing the workout creation request:\", error);\n        return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n            error: \"An internal server error occurred. Please try again later.\"\n        }, {\n            status: 500\n        });\n    }\n}\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///(rsc)/./src/app/api/workouts/postWorkout/route.ts\n");
